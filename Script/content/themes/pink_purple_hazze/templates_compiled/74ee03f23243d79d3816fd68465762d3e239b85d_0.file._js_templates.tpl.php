...
/* Smarty version 4.3.0, created on 2023-01-03 16:20:08
  from 'C:\xampp\htdocs\heavenonearth\Script\content\themes\default\templates\_js_templates.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.0',
  'unifunc' => 'content_63b455b8b43ff4_28685356',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '74ee03f23243d79d3816fd68465762d3e239b85d' => 
    array (
      0 => 'C:\\xampp\\htdocs\\heavenonearth\\Script\\content\\themes\\default\\templates\\_js_templates.tpl',
      1 => 1667647504,
      2 => 'file',
    ),
  ),
...
function content_63b455b8b43ff4_28685356 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_checkPlugins(array(0=>array('file'=>'C:\\xampp\\htdocs\\heavenonearth\\Script\\vendor\\smarty\\smarty\\libs\\plugins\\modifier.number_format.php','function'=>'smarty_modifier_number_format',),));
?>
...
><?php echo '<script'; ?>
 id="modal-success" type="text/template"><div class="modal-body text-center"><div class="big-icon success"><i class="fa fa-check-circle fa-3x"></i></div><h4>{{title}}</h4><p class="mt20">{{message}}</p></div><?php echo '</script'; ?>
><?php echo '<script'; ?>
...
?><div class="item"><i data-emoji="<?php echo $_smarty_tpl->tpl_vars['emoji']->value['unicode_char'];?>
...
</label><div><span class="badge badge-success text-lg"><?php echo print_money(smarty_modifier_number_format($_smarty_tpl->tpl_vars['user']->value->_data['user_affiliate_balance'],2));?>
...
</label><div><span class="badge badge-success text-lg"><?php echo print_money((smarty_modifier_number_format(((1/$_smarty_tpl->tpl_vars['system']->value['points_per_currency'])*$_smarty_tpl->tpl_vars['user']->value->_data['user_points']),2)));?>
</span></div></div><div class="form-group"><label class="form-control-label" for="amount"><?php echo __("Amount");?>
</label><div class="input-money <?php echo $_smarty_tpl->tpl_vars['system']->value['system_currency_dir'];?>
"><span><?php echo $_smarty_tpl->tpl_vars['system']->value['system_currency_symbol'];?>
</span><input type="text" class="form-control" placeholder="0.00" min="1.00" max="1000" name="amount"></div></div><!-- error --><div class="alert alert-danger mb0 mt10 x-hidden"></div><!-- error --></div><div class="modal-footer"><button type="button" class="btn btn-light" data-dismiss="modal"><?php echo __("Cancel");?>
...
</label><div><span class="badge badge-success text-lg"><?php echo print_money(smarty_modifier_number_format($_smarty_tpl->tpl_vars['user']->value->_data['user_funding_balance'],2));?>
</span></div></div><div class="form-group"><label class="form-control-label" for="amount"><?php echo __("Amount");?>
</label><div class="input-money <?php echo $_smarty_tpl->tpl_vars['system']->value['system_currency_dir'];?>
"><span><?php echo $_smarty_tpl->tpl_vars['system']->value['system_currency_symbol'];?>
</span><input type="text" class="form-control" placeholder="0.00" min="1.00" max="1000" name="amount"></div></div><!-- error --><div class="alert alert-danger mb0 mt10 x-hidden"></div><!-- error --></div><div class="modal-footer"><button type="button" class="btn btn-light" data-dismiss="modal"><?php echo __("Cancel");?>
...
><?php echo '<script'; ?>
 id="wallet-withdraw-monetization" type="text/template"><div class="modal-header"><h6 class="modal-title"><i class="fa fa-comment-dollar mr5"></i><?php echo __("Withdraw Monetization Credit");?>
</h6><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button></div><form class="js_ajax-forms" data-url="payments/wallet.php?do=wallet_withdraw_monetization"><div class="modal-body"><div class="form-group"><label class="form-control-label" for="amount"><?php echo __("Your Monetization Credit");?>
</label><div><span class="badge badge-success text-lg"><?php echo print_money(smarty_modifier_number_format($_smarty_tpl->tpl_vars['user']->value->_data['user_monetization_balance'],2));?>
</span></div></div><div class="form-group"><label class="form-control-label" for="amount"><?php echo __("Amount");?>
</label><div class="input-money <?php echo $_smarty_tpl->tpl_vars['system']->value['system_currency_dir'];?>
"><span><?php echo $_smarty_tpl->tpl_vars['system']->value['system_currency_symbol'];?>
</span><input type="text" class="form-control" placeholder="0.00" min="1.00" max="1000" name="amount"></div></div><!-- error --><div class="alert alert-danger mb0 mt10 x-hidden"></div><!-- error --></div><div class="modal-footer"><button type="button" class="btn btn-light" data-dismiss="modal"><?php echo __("Cancel");?>
...
</h6><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button></div><div class="modal-body text-center"><div class="row justify-content-center" style="margin-left: -5px; margin-right: -5px;"><?php if ($_smarty_tpl->tpl_vars['system']->value['paypal_enabled']) {?><div class="col-12 col-sm-4 plr5"><button class="js_payment-paypal btn btn-block btn-payment plr20 mb10" data-handle="{{handle}}" {{#id}} data-id="{{id}}" {{/id}} {{#price}} data-price="{{price}}" {{/price}} {{#node}} data-node="{{node}}" {{/node}}><i class="fab fa-paypal fa-lg fa-fw mr5" style="color: #00186A;"></i><?php echo __("PayPal");?>
</button></div><?php }
if ($_smarty_tpl->tpl_vars['system']->value['creditcard_enabled']) {?><div class="col-12 col-sm-4 plr5"><button class="js_payment-stripe btn btn-block btn-payment plr20 mb10" data-handle="{{handle}}" {{#id}} data-id="{{id}}" {{/id}} {{#price}} data-price="{{price}}" {{/price}} {{#node}} data-node="{{node}}" {{/node}} {{#name}} data-name="{{name}}" {{/name}} {{#img}} data-img="{{img}}" {{/img}} data-method="credit"><i class="fa fa-credit-card fa-lg fa-fw mr5" style="color: #8798CC;"></i><?php echo __("Credit Card");?>
</button></div><?php }
if ($_smarty_tpl->tpl_vars['system']->value['alipay_enabled']) {?><div class="col-12 col-sm-4 plr5"><button class="js_payment-stripe btn btn-block btn-payment plr20 mb10" data-handle="{{handle}}" {{#id}} data-id="{{id}}" {{/id}} {{#price}} data-price="{{price}}" {{/price}} {{#node}} data-node="{{node}}" {{/node}} {{#name}} data-name="{{name}}" {{/name}} {{#img}} data-img="{{img}}" {{/img}} data-method="alipay"><i class="fab fa-alipay fa-lg fa-fw mr5" style="color: #5B9EDD;"></i><?php echo __("Alipay");?>
</button></div><?php }
if ($_smarty_tpl->tpl_vars['system']->value['paystack_enabled']) {?><div class="col-12 col-sm-4 plr5"><button class="js_payment-paystack btn btn-block btn-payment plr20 mb10" data-handle="{{handle}}" {{#id}} data-id="{{id}}" {{/id}} {{#price}} data-price="{{price}}" {{/price}} {{#node}} data-node="{{node}}" {{/node}}><?php $_smarty_tpl->_subTemplateRender('file:__svg_icons.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('icon'=>"paystack",'width'=>"20px",'height'=>"20px",'class'=>"mr5"), 0, true);
echo __("Paystack");?>
</button></div><?php }
if ($_smarty_tpl->tpl_vars['system']->value['coinpayments_enabled']) {?><div class="col-12 col-sm-4 plr5"><button class="js_payment-coinpayments btn btn-block btn-payment plr20 mb10" data-handle="{{handle}}" {{#id}} data-id="{{id}}" {{/id}} {{#price}} data-price="{{price}}" {{/price}} {{#node}} data-node="{{node}}" {{/node}}><i class="fab fa-bitcoin fa-lg fa-fw mr5" style="color: #FFC107;"></i><?php echo __("CoinPayments");?>
</button></div><?php }
if ($_smarty_tpl->tpl_vars['system']->value['2checkout_enabled']) {?><div class="col-12 col-sm-4 plr5"><button class="btn btn-block btn-payment plr20 mb10" data-toggle="modal" data-url="#twocheckout" data-options='{ "handle": "{{handle}}", "id": "{{id}}", "price": "{{price}}", "node": "{{node}}" }'><?php $_smarty_tpl->_subTemplateRender('file:__svg_icons.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('icon'=>"2co",'width'=>"20px",'height'=>"20px",'class'=>"mr5"), 0, true);
echo __("2Checkout");?>
</button></div><?php }
if ($_smarty_tpl->tpl_vars['system']->value['razorpay_enabled']) {?><div class="col-12 col-sm-4 plr5"><button class="btn btn-block btn-payment plr20 mb10" data-toggle="modal" data-url="#razorpay" data-options='{ "handle": "{{handle}}", "id": "{{id}}", "price": "{{price}}", "node": "{{node}}" }'><?php $_smarty_tpl->_subTemplateRender('file:__svg_icons.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('icon'=>"razorpay",'width'=>"20px",'height'=>"20px",'class'=>"mr5"), 0, true);
echo __("Razorpay");?>
</button></div><?php }
if ($_smarty_tpl->tpl_vars['system']->value['cashfree_enabled']) {?><div class="col-12 col-sm-4 plr5"><button class="btn btn-block btn-payment plr20 mb10" data-toggle="modal" data-url="#cashfree" data-options='{ "handle": "{{handle}}", "id": "{{id}}", "price": "{{price}}", "node": "{{node}}" }'><img width="20px" height="20px" src="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
/content/themes/<?php echo $_smarty_tpl->tpl_vars['system']->value['theme'];?>
/images/cashfree.png" class="mr5"><?php echo __("Cashfree");?>
</button></div><?php }
if ($_smarty_tpl->tpl_vars['system']->value['coinbase_enabled']) {?><div class="col-12 col-sm-4 plr5"><button class="js_payment-coinbase btn btn-block btn-payment plr20 mb10" data-handle="{{handle}}" {{#id}} data-id="{{id}}" {{/id}} {{#price}} data-price="{{price}}" {{/price}} {{#node}} data-node="{{node}}" {{/node}}><?php $_smarty_tpl->_subTemplateRender('file:__svg_icons.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('icon'=>"coinbase",'width'=>"20px",'height'=>"20px",'class'=>"mr5"), 0, true);
echo __("Coinbase");?>
</button></div><?php }
if ($_smarty_tpl->tpl_vars['system']->value['securionpay_enabled']) {?><div class="col-12 col-sm-4 plr5"><button class="js_payment-securionpay btn btn-block btn-payment plr20 mb10" data-handle="{{handle}}" {{#id}} data-id="{{id}}" {{/id}} {{#price}} data-price="{{price}}" {{/price}} {{#node}} data-node="{{node}}" {{/node}}><?php $_smarty_tpl->_subTemplateRender('file:__svg_icons.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('icon'=>"securionpay",'width'=>"20px",'height'=>"20px",'class'=>"mr5"), 0, true);
echo __("SecurionPay");?>
</button></div><?php }
if ($_smarty_tpl->tpl_vars['system']->value['bank_transfers_enabled']) {?><div class="col-12 col-sm-4 plr5"><button class="btn btn-block btn-payment plr20 mb10" data-toggle="modal" data-url="#bank-transfer" data-options='{ "handle": "{{handle}}", "id": "{{id}}", "price": "{{price}}", "node": "{{node}}" }' data-size="large"><i class="fa fa-university fa-lg fa-fw mr5" style="color: #4CAF50;"></i><?php echo __("Bank Transfer");?>
</button></div><?php }
...
</label><input name="billing_zip_code" type="text" class="form-control" required></div></div></div><!-- error --><div class="alert alert-danger mb0 x-hidden"></div><!-- error --></div><div class="modal-footer"><input type="hidden" name="token" value="" /><input type="hidden" name="handle" value="{{handle}}"><input type="hidden" name="id" value="{{id}}"><input type="hidden" name="price" value="{{price}}"><input type="hidden" name="node" value="{{node}}"><button type="button" class="btn btn-light" data-dismiss="modal"><?php echo __("Cancel");?>
...
" /></div></div><!-- error --><div class="alert alert-danger mb0 x-hidden"></div><!-- error --></div><div class="modal-footer"><input type="hidden" name="handle" value="{{handle}}" /><input type="hidden" name="id" value="{{id}}" /><input type="hidden" name="price" value="{{price}}" /><input type="hidden" name="node" value="{{node}}"><button type="button" class="btn btn-light" data-dismiss="modal"><?php echo __("Cancel");?>
</button><button type="submit" class="btn btn-primary"><i class="fa fa-check-circle mr10"></i><?php echo __("Pay");?>
</button></div></form><?php echo '</script'; ?>
...
echo '<script'; ?>
 id="auto-connect-node" type="text/template"><div class="auto-connect-node"><div class="form-group form-row"><label class="col-md-3 form-control-label"><?php echo __("Select");?>
