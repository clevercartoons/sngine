              ...
              <div class="logo-wrapper">
                ...
                {if !$user->_logged_in && $system['newsfeed_public']}
                  ...
                  <a href="#" data-toggle="offcanvas" class="menu-icon d-block d-md-none">
                    {include file='__svg_icons.tpl' icon="header-menu" width="20px" height="20px" style="fill: #000000"}
                  </a>
                  <!-- menu-icon -->
                {/if}
                          ...
                          <div class="dropdown-menu dropdown-menu-right">
                            ...
                            {if $system['points_enabled'] || $system['wallet_enabled'] || $user->_data['can_raise_funding']}
                              ...
                              {if $user->_data['can_monetize_content'] && $user->_data['user_monetization_enabled']}
                                <a class="dropdown-item" href="{$system['system_url']}/settings/monetization">{__("Monetization")}: <span class="badge badge-success">{print_money($user->_data['user_monetization_balance']|number_format:2)}</span></a>
                              {/if}
