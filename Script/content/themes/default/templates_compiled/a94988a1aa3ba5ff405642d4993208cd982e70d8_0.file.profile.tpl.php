<?php
/* Smarty version 4.3.0, created on 2023-01-02 09:49:55
  from 'C:\xampp\htdocs\sngineplatform\Script\content\themes\default\templates\profile.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.0',
  'unifunc' => 'content_63b2a8c3e4aa84_06984309',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'a94988a1aa3ba5ff405642d4993208cd982e70d8' => 
    array (
      0 => 'C:\\xampp\\htdocs\\sngineplatform\\Script\\content\\themes\\default\\templates\\profile.tpl',
      1 => 1668251694,
      2 => 'file',
    ),
  ),
...
function content_63b2a8c3e4aa84_06984309 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_checkPlugins(array(0=>array('file'=>'C:\\xampp\\htdocs\\sngineplatform\\Script\\vendor\\smarty\\smarty\\libs\\plugins\\modifier.date_format.php','function'=>'smarty_modifier_date_format',),));
...
"><?php echo $_smarty_tpl->tpl_vars['profile']->value['mutual_friends_count'];?>
 <?php echo __("Mutual Friends");?>
        ...
        <!-- monetization alert -->
        <?php if ($_smarty_tpl->tpl_vars['system']->value['monetization_enabled'] && $_smarty_tpl->tpl_vars['profile']->value['user_monetization_enabled'] && ($_smarty_tpl->tpl_vars['user']->value->_data['user_group'] < 3 || $_smarty_tpl->tpl_vars['profile']->value['user_id'] == $_smarty_tpl->tpl_vars['user']->value->_data['user_id'])) {?>
          <div class="col-sm-12">
 ...
 <?php echo __("Member");?>
                  ...
                  <li>
                    <div class="about-list-item">
                      <i class="fa fa-newspaper fa-fw fa-lg"></i><?php echo __($_smarty_tpl->tpl_vars['profile']->value['posts_count']);?>
 <?php echo __("Posts");?>
                  ...
                  <li>
                    <div class="about-list-item">
                      <i class="fa fa-images fa-fw fa-lg"></i><?php echo __($_smarty_tpl->tpl_vars['profile']->value['photos_count']);?>
 <?php echo __("Photos");?>
                  ...
                  <li>
                    <div class="about-list-item">
                      <i class="fa fa-video fa-fw fa-lg"></i><?php echo __($_smarty_tpl->tpl_vars['profile']->value['videos_count']);?>
 <?php echo __("Videos");?>
...
/subscribers"><?php echo __("Subscribers");?>
                  ...
                  <span class="badge badge-pill badge-info ml5"><?php echo $_smarty_tpl->tpl_vars['profile']->value['subscribers_count'];?>
</span>
                </div>
                <div class="card-body ptb10 plr10">
                  <div class="row no-gutters">
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
          ...
          <div class="order-3 col-lg-6 order-lg-2">
            <?php if ($_smarty_tpl->tpl_vars['profile']->value['needs_subscription']) {?>
              <?php $_smarty_tpl->_subTemplateRender('file:_need_subscription.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('node_type'=>'user','node_id'=>$_smarty_tpl->tpl_vars['profile']->value['user_id'],'price'=>$_smarty_tpl->tpl_vars['profile']->value['user_monetization_price']), 0, false);
?>
            <?php } else { ?>
              <!-- publisher -->
              <?php if ($_smarty_tpl->tpl_vars['user']->value->_logged_in) {?>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header with-icon with-nav">
                <!-- panel title -->
                <div class="mb20">
                  <i class="fa fa-users mr10"></i><?php echo __("Followings");?>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header with-icon with-nav">
                <!-- panel title -->
                <div class="mb20">
                  <i class="fa fa-users mr10"></i><?php echo __("Subscribers");?>
...
/subscribers">
                      ...
                      <span class="badge badge-pill badge-info"><?php echo $_smarty_tpl->tpl_vars['profile']->value['subscribers_count'];?>
</span>
                    </a>
                  </li>
                </ul>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                  ...
                  <?php if (count($_smarty_tpl->tpl_vars['profile']->value['subscribers']) >= $_smarty_tpl->tpl_vars['system']->value['max_results_even']) {?>
                    <!-- see-more -->
                    <div class="alert alert-info see-more mt0 mb20 js_see-more" data-get="subscribers" data-uid="<?php echo $_smarty_tpl->tpl_vars['profile']->value['user_id'];?>
" data-type="user">
                      <span><?php echo __("See More");?>
</span>
                      <div class="loader loader_small x-hidden"></div>
 ...
 <?php echo __("doesn't have subscribers");?>
        ...
        <?php } elseif ($_smarty_tpl->tpl_vars['view']->value == "photos") {?>
          ...
          <div class="col-12">
            <?php if ($_smarty_tpl->tpl_vars['profile']->value['needs_subscription']) {?>
              <?php $_smarty_tpl->_subTemplateRender('file:_need_subscription.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('node_type'=>'user','node_id'=>$_smarty_tpl->tpl_vars['profile']->value['user_id'],'price'=>$_smarty_tpl->tpl_vars['profile']->value['user_monetization_price']), 0, true);
?>
            <?php } else { ?>
              <div class="card panel-photos">
                <div class="card-header with-icon with-nav">
        ...
        <?php } elseif ($_smarty_tpl->tpl_vars['view']->value == "likes") {?>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header with-icon">
                <!-- panel title -->
                <i class="fa fa-heart mr10"></i><?php echo __("Likes");?>
